...
# Getting onChange a pass in createTrackbar
def empty(a):
    pass

# Stacking the images as in final result
...
while True:
    ...
    # Printing them to change the color
    ...
    # Getting image result after masking
